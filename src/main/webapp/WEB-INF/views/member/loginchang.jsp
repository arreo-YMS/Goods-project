...
<head>
    ...
    <style>
        ...
        <div id="container">
            ...
            <form name="member_input" action="../myapp/member/member_ok.jsp" method="post">
                <div id="login">
            ...
            <br>
            <center><a href="member"><input type="button" value="회원가입" style="width: 120px; height: 30px; background-color: #FFC4EB; color: white; border-color: white;"></a></center>
            </form>
            </div>

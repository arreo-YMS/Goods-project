...
%>
 ...
 %>
   <form name="member_input" action="member_output.jsp" method="post" Onsubmit='return Check()'>
   ...
   <script type = "text/javascript">   
    function Check_id()
    {
     location.href= "../member/checkid.jsp?id="+member_input.id.value.trim();
    }
...
{
var strfocus1 = memeber_input.juminnum1.value.length;ㅋ
if(strfocus1 == 6)
